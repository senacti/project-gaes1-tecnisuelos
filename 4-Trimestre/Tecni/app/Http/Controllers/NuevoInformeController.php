...
class NuevoInformeController extends Controller
{
    ...
    protected function validator(array $data)
    {
        return Validator::make($data, [
            ...
            'revenimiento' => ['required', 'string', 'max:555'],
            'ultrasonico' => ['required', 'string', 'max:555'],
            'esclerometria' => ['required', 'string', 'max:555'],
            'analisis_petrograficos' => ['required', 'string', 'max:555'],
        ]);
    }
