...
<body class="background">
                    ...
                    <ul class="navbar-nav  g-col-6">
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="{{ url('/dashboard') }}">Atras</a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
    ...
    <div id="wrapper">
        <h1 class="container title">Inventario</h1>

        <section class="container-login">
            <div class="img"></div>
            <form method="POST" action="{{route ('storeInventario')}}">>
            @csrf
            ...
            <div class="container">
              ...
              <div class="row">
                ...
                <div class="col">
                    <input type="text" class="form-control" placeholder="Cantidad" required name="cantidad">
                  </div>
              ...
              <div class="row">
                ...
                <div class="col">
                    <input type="file" class="form-control" placeholder="Imagen" required name="imagen">
                  </div>
        ...
        <div id="info">
            ...
            <div class="menu">
                ...
                <ul>
                    <li>
                        <a href="{{ route('crudInventario') }}" class="btn btn-secondarys"> Crud inventario</a>
                    </li>
