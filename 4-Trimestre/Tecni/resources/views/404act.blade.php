...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/styles404act.css') }}">
    <title>404act</title>
</head> 
...
<body class="background">
    <header class="hv-background background wrapper">
        <nav class="navbar navbar-expand-lg navbar-light ">
            <div class="container container-fluid">
                <a class="navbar-brand" href="{{ url('/') }}"><img src="{{ asset('/Imagenes/20230309_161828.png') }}" id="logoTec" alt="Logo"
    ...
    <div id="wrapper">
      ...
      <div class="error-container"> 
        ...
        <p>Lo sentimos, pero la página que buscas no existe o ha sido eliminada.</p>
        </div>
        <img id="bb8" src="{{ asset('/Imagenes/bb83.png') }}" alt="Imagen">
      </section>
</body>
