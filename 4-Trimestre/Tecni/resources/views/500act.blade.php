...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/styles500act.css') }}">
    <title>500act</title>
</head> 
...
<body class="background">
    ...
    <div class="error-container">
        ...
        <p>Lo sentimos ha ocurrido un fallo en el servidor.</p>
        <a href="index">Volver a la pagina de inicio</a>
    </div>
    <img id="rr8" src="{{ asset('/Imagenes/rtd22.png') }}" alt="Imagen">
</body>
