...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/stylesContador.css') }}">
...
<body class="background">
    ...
    <div class="container grid"  style="width: 10rem; white-space: pre-line;  margin-top: 117px  ">
        <div class="row gap-3">
            <div class="card align-items-center col background-cuadro">
                <a href="{{ url('/crudContador') }}"><img class="animated tada" width="70" height="70" src="{{ asset('/Imagenes/target.png') }}" alt="Imagen clientes"></a>
                <div class="card-body">
