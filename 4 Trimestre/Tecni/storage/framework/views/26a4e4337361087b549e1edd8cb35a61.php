...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/stylesIndex.css')); ?>"> 
    ...
    <header class="hv-background">
        <nav class="navbar navbar-expand-lg navbar-light">
            <div class="container container-fluid">
              <a class="navbar-brand" href="<?php echo e(url('/')); ?>"><img src="<?php echo e(asset('Imagenes/20230309_161828.png')); ?>" id="logoTec" alt="Logo" width="200" height="60"  class=""></a>
              ...
              <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
                <ul class="navbar-nav  g-col-6">
                  <li class="nav-item">
                    <a class="nav-link btn btn-secondary" aria-current="page" href="<?php echo e(url('/')); ?>">Inicio</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link btn btn-secondary" href="<?php echo e(url('/')); ?>">Servicios</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link btn btn-secondary" href="<?php echo e(url('/agendar')); ?>">Agendar</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link btn btn-secondary" href="<?php echo e(url('/')); ?>">Contacto</a>
                  </li>
                  <li class="nav-item">
                    <a class="btn btn-primary" href="<?php echo e(url('/login')); ?>" role="button">Iniciar Sesion</a>
                  </li>
                </ul>
              </div>
            </div>
    ...
    <div id="carouselExampleCaptions" class="carousel slide">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="<?php echo e(asset ('Imagenes/imagen2.png')); ?>" class="d-block w-100" alt="imagen2">
            ...
            <div class="carousel-item">
                <img src="<?php echo e(asset ('Imagenes/imagen3.png')); ?>" class="d-block w-100" alt="imagen3">
                <div class="carousel-caption">
                    <h1 class="style-title ">TECNISUELOS</h1>
                    <h3>Pavimentos & Concretos</h3>
                </div>
...
</footer><?php /**PATH C:\xampp\htdocs\project-gaes1-tecnisuelos\4 Trimestre\Tecni\resources\views/index.blade.php ENDPATH**/ ?>