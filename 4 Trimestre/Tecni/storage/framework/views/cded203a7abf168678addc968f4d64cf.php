...
<body class="background">
  <header class="hv-background background wrapper">
    <nav class="navbar navbar-expand-lg navbar-light ">
      <div class="container container-fluid">
        <a class="navbar-brand" href="<?php echo e(url('/')); ?>"><img src="<?php echo e(asset('/Imagenes/20230309_161828.png')); ?>" id="logoTec" alt="Logo" width="200"
            height="60" class=""></a>
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
          <ul class="navbar-nav  g-col-6">
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle btn btn-secondary" href="<?php echo e(url('/#')); ?>" role="button" data-bs-toggle="dropdown"
  ...
  <div id="wrapper">
    ...
    <section class="container-login">
      ...
      <form  method="POST" action="<?php echo e(route ('crear_prueba_campo')); ?>">
      <?php echo csrf_field(); ?>
        <div class="container">
...
</html><?php /**PATH C:\xampp\htdocs\project-gaes1-tecnisuelos\4 Trimestre\Tecni\resources\views/pruebasdeCampo.blade.php ENDPATH**/ ?>