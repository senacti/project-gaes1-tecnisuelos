...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/stylesLabo.css') }}">
    ...
    <div class="container grid"  style="width: 25rem; white-space: pre-line;  margin-top: 117px  ">
        <div class="row gap-3 mb-3">
            <div class="card car-img  align-items-center col background-cuadro ">
               <a href="{{ url('HistoInformes') }}"><img class="animated tada" width="80" height="80" src="{{ asset('/Imagenes/iconoHistorialInformes.png') }}" alt=""></a>
                <div class="card-body">
                    <h5 class="card-title">Historial</h5>
                </div>
            </div>
            <div class="card align-items-center col background-cuadro">
                <a href="{{ url('NuevoInforme') }}" ><img class="animated tada " width="80" height="80" src="{{ asset('/Imagenes/iconoNuevoInforme.png') }}" alt=""></a>
                <div class="card-body">
