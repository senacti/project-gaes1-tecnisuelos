...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('css/stylesRecupContra.css') }}">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
</head>
<body>
      ...
      <div class="container container-fluid">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
          <ul class="navbar-nav  g-col-6">
            ...
            <li class="nav-item">
              <a class="btn btn-primary" href="{{ url('/inicio') }}"role="button">Crear Cuenta</a>
            </li>
          </ul>
        </div>
      </div>
  ...
  <section class="container-login">
    <div class="img"></div>
    <div class="container">
       <h2><b>¿No recuerdas tu Contraseña?</b></h2>
       <h13>!No te preocupes¡ nos sucede a todos, ingresa tu email y te ayudaremos</h13>
      <div class="row">
        <div class="col">
          <input type="email" class="form-control" required placeholder="Correo">
        </div>
        <div >
            <input class="btn btn-third" type="submit" value="Solicitar">
        </div>
